      ...
      <Table>
        <TableHeader className="bg-white/[0.02]">
          <TableRow className="border-white/5">
            <TableHead className="px-6 h-12 text-xs font-semibold text-muted-foreground uppercase">Campaign</TableHead>
            <TableHead className="px-6 h-12 text-xs font-semibold text-muted-foreground uppercase text-center">Folder</TableHead>
            <TableHead className="px-6 h-12 text-xs font-semibold text-muted-foreground uppercase text-center">Total Scans</TableHead>
            <TableHead className="px-6 h-12 text-xs font-semibold text-muted-foreground uppercase text-center">Status</TableHead>
            <TableHead className="px-6 h-12 text-xs font-semibold text-muted-foreground uppercase text-right">Actions</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {campaigns.map((c) => (
            <TableRow key={c.id} className="hover:bg-white/[0.02] border-white/5 transition-colors group">
              ...
              <TableCell className="px-6 py-4 text-center font-mono text-sm">{c.scans.toLocaleString()}</TableCell>
              <TableCell className="px-6 py-4 text-center">
                {c.status === 'active' ? (
              ...
              <TableCell className="px-6 py-4 text-right">
                <DropdownMenu>
                  <DropdownMenuTrigger className={cn(buttonVariants({ variant: "ghost", size: "icon" }), "h-8 w-8 hover:bg-white/5")}>
